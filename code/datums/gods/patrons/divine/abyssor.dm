/datum/patron/divine/abyssor
	name = "Tempestia"
	domain = "The Seas, Dreams, Depths, Storms"
	desc = "The Dreaming Tide fell into an endless sleep during the Godswar, Her consciousness scattered across the ocean depths. Now She dreams terrible dreams - and those dreams spawn horrors from the abyss. Her followers claim the twisted Dreamers are manifestations of Her nightmares about the Cataclysm. Through Her waters may the faithful be cleansed, but beware: if She fully awakens, the world may drown in Her sorrow."
	worshippers = "Fishermen, Sailors, Axians, Lamia, Dreamers"
	...
	confess_lines = list(
		...
		"THE OCEAN'S FURY IS TEMPESTIA'S DREAM!",
...
/datum/patron/divine/abyssor/can_pray(mob/living/follower)
	...
	for(var/turf/open/water in view(4, get_turf(follower)))
		return TRUE
		to_chat(follower, span_danger("For Tempestia to hear my prayer I must either pray within the church, near a holy symbol, or at any body of water so that the tides of prayer may flow.."))
	return FALSE
...
/datum/patron/divine/abyssor/on_lesser_heal(
	...
	*message_self = span_notice("I'm blessed by Tempestia's tide!")
