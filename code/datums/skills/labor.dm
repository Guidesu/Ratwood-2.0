...
/datum/skill/labor/fishing
	...
	dreams = list(
		...
		"...the old merchant nods his head, and gives you a small sack of baits: worms, grubs and even slices of cheese - each said to bring you another of Tempestia's bounties..."
	)
	expert_name = "Fisher"
	max_untraited_level = SKILL_LEVEL_APPRENTICE
	trait_uncap = list(TRAIT_HOMESTEAD_EXPERT = SKILL_LEVEL_LEGENDARY,
