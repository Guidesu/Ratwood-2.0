...
/datum/round_event/dead_whispers/start()
	...
	to_chat(chosen_one, span_userdanger("YOU ARE MORTARA'S CHOSEN!"))
	to_chat(chosen_one, span_notice("You must understand death better to be able to prepare for it. For that purpose, go to the church and listen to the whispers of the dead while wearing amulet of Mortara."))
